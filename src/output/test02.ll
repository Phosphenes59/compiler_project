...
foo:
  ...
  %r102 = getelementptr %Node, ptr %r100, i32 0, i32 0
  store i32 %r101, ptr %r102, align 4
  %r103 = call i32 @getint()
  %r104 = getelementptr %Node, ptr %r100, i32 0, i32 1
...
baz:
  ...
  %r107 = getelementptr %Node, ptr %r105, i32 2
  %r108 = getelementptr %Node, ptr %r107, i32 0, i32 0
  store i32 %r106, ptr %r108, align 4
  %r109 = call i32 @getint()
  %r110 = getelementptr %Node, ptr %r105, i32 2
  %r111 = getelementptr %Node, ptr %r110, i32 0, i32 1
  store i32 %r109, ptr %r111, align 4
  ret void
}
