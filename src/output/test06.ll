...
foo:
  %r101 = getelementptr %Bar, ptr %r100, i32 1
  %r102 = getelementptr %Bar, ptr %r101, i32 0, i32 2
  %r103 = getelementptr [10 x i32], ptr %r102, i32 0, i32 3
  store i32 5, ptr %r103, align 4
  ret void
}

define i32 @main() {
main:
  %r104 = alloca [10 x %Bar], align 8
  call void @_sysy_starttime(i32 18)
  %r105 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r106 = getelementptr %Bar, ptr %r105, i32 0, i32 0
  %r107 = getelementptr %Node, ptr %r106, i32 0, i32 0
  store i32 1, ptr %r107, align 4
  %r108 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r109 = getelementptr %Bar, ptr %r108, i32 0, i32 0
  %r110 = getelementptr %Node, ptr %r109, i32 0, i32 1
  store i32 2, ptr %r110, align 4
  %r111 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r112 = getelementptr %Bar, ptr %r111, i32 0, i32 1
  %r113 = getelementptr [10 x %Node], ptr %r112, i32 0, i32 2
  %r114 = getelementptr %Node, ptr %r113, i32 0, i32 0
  store i32 3, ptr %r114, align 4
  %r115 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r116 = getelementptr %Bar, ptr %r115, i32 0, i32 1
  %r117 = getelementptr [10 x %Node], ptr %r116, i32 0, i32 2
  %r118 = getelementptr %Node, ptr %r117, i32 0, i32 1
  store i32 4, ptr %r118, align 4
  call void @foo(ptr %r104)
  %r119 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r120 = getelementptr %Bar, ptr %r119, i32 0, i32 0
  %r121 = getelementptr %Node, ptr %r120, i32 0, i32 0
  %r122 = load i32, ptr %r121, align 4
  call void @putint(i32 %r122)
  %r123 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r124 = getelementptr %Bar, ptr %r123, i32 0, i32 0
  %r125 = getelementptr %Node, ptr %r124, i32 0, i32 1
  %r126 = load i32, ptr %r125, align 4
  call void @putint(i32 %r126)
  %r127 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r128 = getelementptr %Bar, ptr %r127, i32 0, i32 1
  %r129 = getelementptr [10 x %Node], ptr %r128, i32 0, i32 2
  %r130 = getelementptr %Node, ptr %r129, i32 0, i32 0
  %r131 = load i32, ptr %r130, align 4
  call void @putint(i32 %r131)
  %r132 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r133 = getelementptr %Bar, ptr %r132, i32 0, i32 1
  %r134 = getelementptr [10 x %Node], ptr %r133, i32 0, i32 2
  %r135 = getelementptr %Node, ptr %r134, i32 0, i32 1
  %r136 = load i32, ptr %r135, align 4
  call void @putint(i32 %r136)
  %r137 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 1
  %r138 = getelementptr %Bar, ptr %r137, i32 0, i32 2
  %r140 = getelementptr [10 x i32], ptr %r138, i32 0, i32 3
  %r139 = load i32, ptr %r140, align 4
