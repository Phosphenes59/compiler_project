...
bb2:                                              ; preds = %bb1
  ...
  %r106 = getelementptr [10 x i32], ptr @a, i32 0, i32 %r105
  store i32 %r104, ptr %r106, align 4
...
bb5:                                              ; preds = %bb4
  ...
  %r114 = getelementptr [10 x i32], ptr @a, i32 0, i32 %r112
  %r113 = load i32, ptr %r114, align 4
